...
function passwordTemplate(content, n){
    ...
    copyIcon.setAttribute('src', '../imgs/copyIcon.png');
    ...
    editIcon.setAttribute('src', '../imgs/editIcon.png');
    ...
    acceptIcon.setAttribute('src', '../imgs/tickMark.png');
    ...
    rejectIcon.setAttribute('src', '../imgs/crossMark.png');
    ...
    deleteIcon.setAttribute('src', '../imgs/deleteIcon.png');
